...
while($date <= $newTime){
  ...
  if (timerReady($history_date,90)){$historyFlag=True; $history_date = date('Y-m-d H:i'); Echo "<BR> History Timer ";logAction('Update History Set','CoinPrice', $logToFileSetting);}
