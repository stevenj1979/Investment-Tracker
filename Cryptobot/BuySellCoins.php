...
while($date <= $newTime){
                          ...
                          if (buyWithMin($BuyPriceMinEnabled,$BuyPriceMin,$LiveCoinPrice)){
                            ...
                            if (autoBuy($LiveCoinPrice,$autoBuyPrice, $autoBuyCoinEnabled)){
                              ...
                              if ($GLOBALS['allDisabled'] == true){
                                ...
                                echo "Buying Coins: $APIKey, $APISecret,$symbol, $Email, $userID, $date, $baseCurrency,$SendEmail,$BuyCoin,$BTCAmount, $ruleIDBuy,$UserName,$coinID,$CoinSellOffsetPct,$CoinSellOffsetEnabled,$buyType <BR>";
  ...
  for($a = 0; $a < $sellCoinsLength; $a++) {
    ...
    for($z = 0; $z < $sellRulesSize; $z++) {//Sell Rules
      ...
      $Email = $sellRules[$z][31]; $UserName = $sellRules[$z][32]; $APIKey = $sellRules[$z][33]; $APISecret = $sellRules[$z][34];
