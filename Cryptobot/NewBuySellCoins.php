...
function runSellSavings($spreadBuyBack){
  ...
  for ($u=0; $u<$spreadBuyBackSize; $u++){
    ...
    //  Echo "<BR> CoinID: $CoinID | Sym: $symbol | SellPrice: $sellPrice | Min: $baseMin";
      ...
      newLogToSQL("runSellSavings_v3","$baseCurrency | $sellPrice | $baseMin | $profitPCT | $profitTarget | $noOfBounceSells",3,1,"Profit","TransID:$transactionID");
      ...
      newLogToSQL("runSellSavings_v2","$baseCurrency | $sellPrice | $baseMin | $profitPCT | $profitTarget | $bounceTopPrice | $LiveCoinPrice | $noOfBounceSells",3,1,"Profit","TransID:$transactionID");
