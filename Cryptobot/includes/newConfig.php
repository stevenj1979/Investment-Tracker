...
function setSavingToLivewithMerge($userID, $coinID, $transactionID){
    ...
    if ($conn->connect_error) {
        ...
        SQLInsertUpdateCall("setSavingToLivewithMerge: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
...
function runClosedCalculatedSellPct(){
    ...
    if ($conn->connect_error) {
        ...
        SQLInsertUpdateCall("runClosedCalculatedSellPct: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function saveHoldingAmount($userID, $holdAmount,$baseCurrency,$transactionID){
    ...
    if ($conn->connect_error) {
        ...
        SQLInsertUpdateCall("saveHoldingAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function removeHoldingAmount($userID, $holdAmount,$baseCurrency,$transactionID){
    ...
    if ($conn->connect_error) {
        ...
        SQLInsertUpdateCall("removeHoldingAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function removeFromSpread($transID){
    ...
    if ($conn->connect_error) {
        ...
        SQLInsertUpdateCall("removeFromSpread: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function saveResidualAmountToBittrex($TransactionID,$residualAmount){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("saveResidualAmountToBittrex: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function reopenCoinSwapCancel($transID, $nFlag){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("reopenCoinSwapCancel: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function removeTransactionDelay($coinID, $userID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("removeTransactionDelay: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function bittrexActionBuyBack($coinID,$oldBuyBackTransID,$buyBack = 1){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("bittrexActionBuyBack: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function bittrexActionReduceLoss($coinID,$trackingID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("bittrexActionReduceLoss: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function clearTrackingCoinQueue($UserID,$coinID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    $sql = "UPDATE `TrackingCoins` SET `MinsToCancelBuy` = 0 where `CoinID` = $coinID and `UserID` = $UserID ";
    SQLInsertUpdateCall("clearTrackingCoinQueue: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function deleteFromBittrexAction($bittrexRef){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("deleteFromBittrexAction: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateBuyToSpread($sbRuleID, $transactionID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateBuyToSpread: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateSQLSold($amount,$livePrice, $cost, $date, $transactionID,$profit){
    ...
    SQLInsertUpdateCall("updateSQLSold: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function addCoinPurchaseDelay($coinID,$userID,$days, $daysEnabled){
    ...
    if ($conn->connect_error) {
        ...
        SQLInsertUpdateCall("addCoinPurchaseDelay: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function bittrexAllBalances($apikey, $apisecret, $versionNum){
    $nonce=time();
    if ($versionNum == 1){
      $uri='https://bittrex.com/api/v1.1/account/getorder?apikey='.$apikey.'&uuid='.$uuid.'&nonce='.$nonce;
      //echo "<br>$uri<br>";
...
function getSpreadBetTrackingCoins($whereclause, $table){
  ...
  if ($conn->connect_error) {
    ...
    ,sum(`Last1HrChange`) as Last1HrChange,sum((`LiveCoinPrice`-`Live1HrChange`)/100)*`LiveCoinPrice` as Hr1ChangePctChange ,sum(`Live24HrChange`) as Live24HrChange,sum(`Last24HrChange`) as Last24HrChange,sum((`LiveCoinPrice`-`Live24HrChange`)/100)*`LiveCoinPrice` as Hr24ChangePctChange,sum(`Live7DChange`) as Live7DChange,sum(`Last7DChange`) as Last7DChange
    ,sum((`LiveCoinPrice`-`Live7DChange`)/100)*`LiveCoinPrice` as D7ChangePctChange,Trim(sum(`LiveCoinPrice`))+0 as LiveCoinPrice,Trim(sum(`LastCoinPrice`))+0 as LastCoinPrice,sum((`LiveCoinPrice`-`LastCoinPrice`)/100)*`LiveCoinPrice`as CoinPricePctChange,sum(`LiveSellOrders`) as LiveSellOrders,sum(`LastSellOrders`) as LastSellOrders
    ,sum((`LiveSellOrders`-`LastSellOrders`)/100)*`LiveSellOrders`as SellOrdersPctChange
    ...
    ,max(`MaxHoursFlat`) as MaxHoursFlat,avg(`CaaOffset`) as CaaOffset,avg(`CaaMinsToCancelBuy`) as CaaMinsToCancelBuy,avg(`HoursFlatHighPdcs`) as HoursFlatHighPdcs,avg(`HoursFlatLowPdcs`) as HoursFlatLowPdcs
...
function getTrackingSpreadBetSellCoins($type, $userID = 0){
  ...
  ,sum(`LiveMarketCap`) as `LiveMarketCap`,sum(((`LiveMarketCap` - `LastMarketCap`) / `LastMarketCap`) * 100) as `MarketCapPctChange`,sum(`LastCoinPrice`) as `LastCoinPrice`,sum(`LiveCoinPrice`) as `LiveCoinPrice`
  ,sum(((`LiveCoinPrice` - `LastCoinPrice`) / `LastCoinPrice`) * 100) as `CoinPricePctChange`
  ,sum(`LastSellOrders`) as `LastSellOrders`,sum(`LiveSellOrders`) as `LiveSellOrders`,sum(((`LiveSellOrders` - `LastSellOrders`) / `LastSellOrders`) * 100) as `SellOrdersPctChange`,sum(`LastVolume`) as `LastVolume`,sum(`LiveVolume`) as `LiveVolume`
  ,sum(((`LiveVolume` - `LastVolume`) / `LastVolume`) * 100) as `VolumePctChange`
  ,sum(`Last1HrChange`) as `Last1HrChange`
  ,sum(`Live1HrChange`) as `Live1HrChange`,sum(((`LiveCoinPrice`- `Live1HrChange`) / `Live1HrChange`) * 100) as `Hr1ChangePctChange`,sum(`Last24HrChange`) as `Last24HrChange`,sum(`Live24HrChange`) as `Live24HrChange`
  ,sum(((`LiveCoinPrice` - `Live24HrChange`) / `Live24HrChange`) * 100)  as `Hr24ChangePctChange`,sum(`Last7DChange`) as `Last7DChange`
...
//  }
  ...
  //}
  //if ($BTCBalance < $btcBuyAmount){
    //$tempFee = ($BTCBalance/100)*0.82;
    //$btcBuyAmount = round(($BTCBalance-$tempFee)/$bitPrice,10);
  ...
  //if ($btcBuyAmount > $minTradeAmount) {
    ...
    if ($btcBuyAmount >= $newMinTradeAmount  && $BTCBalance >= $buyMin){
        ...
        if ($buyCoin){
          ...
          logToSQL("Bittrex", "Error: ".json_encode($obj), $userID,1);
          $retBuy = 2;
        }
...
function updateCoinSwapTable($transactionID,$status,$bittrexRef,$newCoinID,$newCoinPrice,$baseCurrency,$totalAmount,$purchasePrice,$buyFlag){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateCoinSwapTable: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateCoinSwapTransactionStatus($status,$transID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateCoinSwapTransactionStatus: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function addOldBuyBackTransID($bBID,$tmpCoinID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("addOldBuyBackTransID: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function addBuyBackTransID($bBTransID,$transactionID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("addBuyBackTransID: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function deleteMultiSellRuleConfig($transactionID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("deleteMultiSellRuleConfig: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateCoinSwapStatus($status,$transID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateCoinSwapStatus: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateCoinSwapStatusCoinSwapID($status,$transactionID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateCoinSwapStatusCoinSwapID: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function reopenCoinSwap($transID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("reopenCoinSwap: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateCoinSwapStatusFinalPrice($status,$transID,$finalPrice){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateCoinSwapStatusFinalPrice: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateCoinSwapCoinDetails($coinID, $coinPrice, $amount, $orderNo, $status, $transID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    `Amount` = $amount,`OrderNo` = '$orderNo', `Status` = '$status', `DelayCoinSwapUntil` = date_add(now(),INTERVAL 14 DAY),`OriginalAmount` = 0
    where `ID` = $transID";
     SQLInsertUpdateCall("updateCoinSwapCoinDetails: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateCoinSwapBittrexID($bittrexRef,$transactionID,$newCoinID,$newPrice,$buyFlag, $sellFinalPrice = 0.0){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateCoinSwapBittrexID: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function addCoinAllocationOverride($overrideCoinAlloc, $bittrexRef){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("addCoinAllocationOverride: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function writeFixedSellRule($SellRuleFixed,$bittrexRef){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("writeFixedSellRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function writeSQLTransBuy($type, $coinID,$userID, $cost,$amounttobuy, $date, $BittrexID, $orderNo){
  ...
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("writeSQLTransBuy: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function writeBittrexActionBuy($coinID,$transactionID,$userID,$type,$bittrexRef,$date,$status,$sellPrice,$ruleID){
    ...
    SQLInsertUpdateCall("writeBittrexActionBuy: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function disableBuyRule($ruleIDBuy){
    ...
    SQLInsertUpdateCall("disableBuyRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function reOpenOneTimeBuyRule($trackingID){
  ...
  SQLInsertUpdateCall("reOpenOneTimeBuyRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyTradeAmountToSQL($coinID, $minTradeAmount, $precision){
  ...
  SQLInsertUpdateCall("copyTradeAmountToSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexCoinPrice($apikey, $apisecret, $baseCoin, $coin, $versionNum){
      ...
      if ($versionNum == 1){
        ...
        //var_dump($temp);
        logAction("bittrexCoinPrice: ".var_dump($temp), 'CryptoBotAuto', 0);
...
function writeBittrexAction($coinID,$transactionID,$userID,$type,$bittrexRef,$date,$status,$sellPrice){
    ...
    SQLInsertUpdateCall("writeBittrexAction: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function CoinMarketCapStatstoSQL($coinID,$MarketCap,$hr1Change, $hr24Change, $d7Change){
  ...
  SQLInsertUpdateCall("CoinMarketCapStatstoSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function ResidualCoinsToSaving($amount, $orderNo, $transactionID,$originalAmount){
  ...
  SQLInsertUpdateCall("ResidualCoinsToSaving: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function BittrexStatstoSQL($coinID, $volume, $sellOrders, $buyOrders){
  ...
  SQLInsertUpdateCall("BittrexStatstoSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyNewMarketCap($coinID,$MarketCap){
  ...
  SQLInsertUpdateCall("copyNewMarketCap: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function addBuyRuletoSQL($bittrexRef, $buyRule,$sellRule){
  ...
  SQLInsertUpdateCall("addBuyRuletoSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function addSellRuletoSQL($transactionID, $sellRule){
  ...
  SQLInsertUpdateCall("addSellRuletoSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyNewPctChange($coinID,$PctChange1Hr, $PctChange24Hr, $PctChange7D){
  ...
  SQLInsertUpdateCall("copyNewPctChange: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyCoinVolume($coinID,$CoinVolume){
  ...
  SQLInsertUpdateCall("copyCoinVolume: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyCoinBuyOrders($coinID,$CoinBuyOrders){
  ...
  SQLInsertUpdateCall("copyCoinBuyOrders: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyCoinSellOrders($coinID,$CoinSellOrders){
  ...
  SQLInsertUpdateCall("copyCoinSellOrders: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyCoinPrice($coinID,$CoinPrice, $askPrice, $bidPrice){
  ...
  SQLInsertUpdateCall("copyCoinPrice: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateWebCoinStatsTable($coinID){
  ...
  SQLInsertUpdateCall("updateWebCoinStatsTable: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateCoinAllocation($userID, $mode, $baseCurrency, $buyAmount){
  ...
  SQLInsertUpdateCall("updateCoinAllocation: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r("<BR>".$sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSQL($baseCurrency, $transactionID, $BittrexID){
    ...
    SQLInsertUpdateCall("updateSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateTransStatus($transactionID,$status){
    ...
    SQLInsertUpdateCall("updateTransStatus: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function clearBittrexRef($transactionID){
  /*  $conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("clearBittrexRef: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function cancelBittrexSQL($id){
  ...
  SQLInsertUpdateCall("cancelBittrexSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function changeTransStatus($transactionID){
  ...
  SQLInsertUpdateCall("changeTransStatus: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexBuyAdd($coinID, $userID, $type, $bittrexRef, $status, $ruleID, $cost, $amount, $orderNo,$timeToCancelBuyMins,$sellRuleFixed,$SBRuleID,$SBTransID){
  ...
  SQLInsertUpdateCall("bittrexBuyAdd: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexAddNoOfPurchases($bittrexRef, $noOfPurchases){
  ...
  SQLInsertUpdateCall("bittrexAddNoOfPurchases: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexSellAdd($coinID, $transactionID, $userID, $type, $bittrexRef, $status, $bitPrice, $ruleID){
  ...
  SQLInsertUpdateCall("bittrexSellAdd: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexSellCancel($bittrexRef, $transactionID, $errorCode){
  ...
  SQLInsertUpdateCall("bittrexSellCancel: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexBuyCancel($bittrexRef, $transactionID, $errorCode){
  ...
  SQLInsertUpdateCall("bittrexBuyCancel: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexBuyComplete($bittrexRef,$transactionID, $finalPrice, $type){
  ...
  SQLInsertUpdateCall("bittrexBuyComplete: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexSellComplete($bittrexRef,$transactionID, $finalPrice){
  ...
  SQLInsertUpdateCall("bittrexSellComplete: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexBuyCompleteUpdateAmount($transactionID, $amount){
  ...
  SQLInsertUpdateCall("bittrexBuyCompleteUpdateAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexSellCompleteUpdateAmount($transactionID, $amount){
  ...
  SQLInsertUpdateCall("bittrexSellCompleteUpdateAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyCoinHistory($coin){
  ...
  SQLInsertUpdateCall("copyCoinHistory: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyBuyHistory($coinID){
  ...
  SQLInsertUpdateCall("copyBuyHistory: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function coinPriceHistorySpreadBet($coinID,$price,$baseCurrency,$date,$hr1Pct,$hr24Pct,$d7Pct){
  ...
  SQLInsertUpdateCall("coinPriceHistorySpreadBet: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function update1HrPriceChange($price,$coinID){
  ...
  SQLInsertUpdateCall("update1HrPriceChange: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function update7DPriceChange($sevenDayPrice,$coinID){
  ...
  SQLInsertUpdateCall("update7DPriceChange: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function update24HrPriceChange($price,$coinID){
  ...
  SQLInsertUpdateCall("update24HrPriceChange: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function update8HrPriceChange($price,$coinID){
  ...
  SQLInsertUpdateCall("update8HrPriceChange: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function bittrexUpdateBuyQty($transactionID, $quantity){
  ...
  SQLInsertUpdateCall("bittrexUpdateBuyQty: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r("<br>".$sql);
...
function bittrexUpdateSellQty($transactionID, $quantity){
  ...
  SQLInsertUpdateCall("bittrexUpdateSellQty: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r("<br>".$sql);
  if ($conn->query($sql) === TRUE) {echo "New record created successfully";
  } else {
    echo "Error: " . $sql . "<br>" . $conn->error;
...
function bittrexCopyTransNewAmount($transactionID, $oQuantity, $nQuantity, $orderNo){
  ...
  SQLInsertUpdateCall("bittrexCopyTransNewAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r("<br>".$sql);
  if ($conn->query($sql) === TRUE) {echo "New record created successfully";
  } else {
    echo "Error: " . $sql . "<br>" . $conn->error;
...
function logToSQL($subject, $comments, $UserID, $enabled){
  if ($enabled == 1){
    ...
    SQLInsertUpdateCall("logToSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r("<br>".$sql);
    if ($conn->query($sql) === TRUE) {echo "New record created successfully";
    } else {
      echo "Error: " . $sql . "<br>" . $conn->error;
...
function newLogToSQL($subject, $comments, $UserID, $enabled, $subTitle, $ref){
  if ($enabled == 1){
    ...
    SQLInsertUpdateCall("newLogToSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r("<br>".$sql);
    if ($conn->query($sql) === TRUE) {echo "New record created successfully";
    } else {
      echo "Error: " . $sql . "<br>" . $conn->error;
...
function newerLogToSQL($subject, $comments, $UserID, $enabled, $subTitle, $ref, $daysToKeep){
  if ($enabled == 1){
    ...
    SQLInsertUpdateCall("newerLogToSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r("<br>".$sql);
    if ($conn->query($sql) === TRUE) {echo "New record created successfully";
    } else {
      echo "Error: " . $sql . "<br>" . $conn->error;
...
function echoAndLog($subject, $comments, $UserID, $enabled, $subTitle, $ref){
  ...
  if ($enabled > 1){
    SQLInsertUpdateCall("echoAndLog: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*$conn = getSQLConn(rand(1,3));
    if ($conn->connect_error) {die("Connection failed: " . $conn->connect_error);}
    //print_r("<br>".$sql);
...
function SuperLog($nFile, $comments,  $nFunction, $title , $ref, $logSettingAry, $nType){
  ...
  //echo "<BR> SQL TEST: START $sql END Enabled:$enabled Mode:$mode Days:$days ";
  if ($enabled == 1) {
    if ($mode > 0){
    ...
    if ($mode > 1){
      SQLInsertUpdateCall("SuperLog: ",$sql,3, 1, 1, 0, "NewConfig", 90);
      /*$conn = getSQLConn(rand(1,3));
      if ($conn->connect_error) {die("Connection failed: " . $conn->connect_error);}
      //print_r("<br>".$sql);
      if ($conn->query($sql) === TRUE) {echo "";
...
function displaySubHeader($page){
  ...
  if ($page == 'BuyCoin'){
    ...
    echo "<h3><a href='SellCoins.php'>Sell Coins ($sellCoin)</a> &nbsp > &nbsp <a href='SellCoins_Tracking.php'>Tracking ($sellTracking)</a> &nbsp > &nbsp <a href='SellCoins_Saving.php'>Saving ($sellSaving)</a> &nbsp > &nbsp <a href='SellCoins_Spread.php'>Spread Bet ($spreadSell)</a>
    &nbsp > &nbsp <a href='SellCoins_SpreadCoin.php'>Spread Bet Coin ($spreadSellCoin)</a> &nbsp > &nbsp <a href='SellCoins_SwapCoins.php'>Swap Coins</a></h3>";
  }elseif ($page == 'Profit'){
...
function updateSQLBittrexSellReRunTrans($amount,$bittrexRef,$transactionID,$bitPrice,$BittrexID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateSQLBittrexSellReRunTrans: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateSQLBittrexSellReRunBittrex($amount,$bittrexRef,$transactionID,$bitPrice,$BittrexID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateSQLBittrexSellReRunBittrex: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function runBittrexHold($bittrexID){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("runBittrexHold: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateCoinAlertsbyID($id, $coinID, $action, $userID, $category, $reocurring, $price){
  ...
  SQLInsertUpdateCall("updateCoinAlertsbyID: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function closeCoinAlerts($id, $table){
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("closeCoinAlerts: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateAlertTime($id, $table){
  ...
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateAlertTime: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function updateBittrexQuantityFilled($quantFilled, $bittrexRef){
  ...
  /*$conn = getSQLConn(rand(1,3));
    ...
    SQLInsertUpdateCall("updateBittrexQuantityFilled: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function cancelReduceLoss($userID, $baseCurrency){
  $current_date = date('Y-m-d H:i');
  /*$conn = getSQLConn(rand(1,3));
    // Check connection
    if ($conn->connect_error) {
    ...
    $sql = "UPDATE `TrackingCoins` SET `Status` = 'Closed'  WHERE `Status` = 'Open' and `UserID` = $userID and `BaseCurrency` = '$baseCurrency' and `Type` = 'buyToreduceLoss';";
    SQLInsertUpdateCall("cancelReduceLoss: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
    ...
    $conn->close();
    newLogToSQL("cancelReduceLoss",$sql,3,0,"SQL","UserID:$userID");*/
}
...
function addCoinSwapIDtoTracking($coinSwapID,$transID){
  ...
  SQLInsertUpdateCall("addCoinSwapIDtoTracking: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
...
function addTrackingCoin($coinID, $coinPrice, $userID, $baseCurrency, $sendEmail, $buyCoin, $quantity, $ruleIDBuy, $coinSellOffsetPct, $coinSellOffsetEnabled, $buyType, $minsToCancelBuy, $sellRuleFixed, $toMerge, $noOfPurchases, $risesInPrice, $type, $originalPrice,$spreadBetTransID,$spreadBetRuleID,$overrideCoinAlloc,$callName, $savingOverride, $transID = 0){
  ...
  SQLInsertUpdateCall("AddTrackingCoin: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  //print_r($sql);
  //LogToSQL("SpreadBetTrackingSQL","$sql",3,0);
  //if ($conn->query($sql) === TRUE) {
  //    echo "New record created successfully";
...
function updateReduceLossCounter($transID,$callName){
  ...
  SQLInsertUpdateCall("updateReduceLossCounter: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  //print_r($sql);
...
function addReduceLossCounterToTrans($reduceLossCounter,$coinID,$userID,$callName){
  ...
  SQLInsertUpdateCall("addReduceLossCounterToTrans: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  //print_r($sql);
...
function runLowMarketMode($userID,$mode){
  ...
  SQLInsertUpdateCall("runLowMarketMode: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  //print_r($sql);
  //if ($conn->query($sql) === TRUE) {
  //    echo "New record created successfully";
  //} else {
...
function updateCoinAllocationOverride($coinID,$userID,$overrideCoinAlloc,$toMerge){
  ...
  $sql = "UPDATE `Transaction` SET `OverrideCoinAllocation` = $overrideCoinAlloc, `ToMerge` = $toMerge where `CoinID` = $coinID and `UserID` = $userID
            ...
            Limit 1 ";
  SQLInsertUpdateCall("updateCoinAllocationOverride: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  //print_r($sql);
  //if ($conn->query($sql) === TRUE) {
  //    echo "New record created successfully";
  //} else {
...
function setLastPrice($coinPrice, $ID, $mode){
  ...
  SQLInsertUpdateCall("setLastPrice: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function closeNewTrackingCoin($ID, $deleteFlag, $verNum, $reason){
  ...
  SQLInsertUpdateCall("closeNewTrackingCoin: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
    echo "New record created successfully";
  } else {
...
function reOpenBuySellProfitRule($ruleID, $userID, $coinID){
  ...
  SQLInsertUpdateCall("reOpenBuySellProfitRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateTrackingCoinToMerge($ID){
  ...
  SQLInsertUpdateCall("updateTrackingCoinToMerge: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateReduceLossSettings($ID){
  ...
  SQLInsertUpdateCall("updateReduceLossSettings: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function UpdateTransCount($count,$transactionID){
  ...
  SQLInsertUpdateCall("UpdateTransCount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function mergeTransactions($transactionID, $amount, $avCost){
  ...
  SQLInsertUpdateCall("mergeTransactions: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function closeOldTransSQL($id){
  ...
  SQLInsertUpdateCall("closeOldTransSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateNoOfRisesInPrice($newTrackingCoinID, $num){
  ...
  SQLInsertUpdateCall("updateNoOfRisesInPrice: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function copyMultiSellIDfromRule($ruleIDBTBuy, $transactionID){
  ...
  SQLInsertUpdateCall("copyMultiSellIDfromRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function writeMultiRule($sellRuleIDFromTemplate,$transactionID,$userID){
  ...
  SQLInsertUpdateCall("writeMultiRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function writeMultiRuleTemplateID($transactionID,$multiSellRuleTemplateID){
  ...
  SQLInsertUpdateCall("writeMultiRuleTemplateID: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function newTrackingSellCoins($LiveCoinPrice, $userID,$transactionID,$SellCoin,$SendEmail,$sellCoinOffsetEnabled,$sellCoinOffsetPct,$fallsInPrice,$type,$callName,$overrideBittrexCancel){
  /*$conn = getSQLConn(rand(1,3));
  // Check connection
  if ($conn->connect_error) {
      die("Connection failed: " . $conn->connect_error);
  }*/
  $sql = "call AddTrackingSellCoin($LiveCoinPrice, $userID,$transactionID,$SellCoin,$SendEmail,$sellCoinOffsetEnabled,$sellCoinOffsetPct,$fallsInPrice,'$type',$overrideBittrexCancel);";
  SQLInsertUpdateCall("newTrackingSellCoins: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function setBuyPct($bounceDifference,$transactionID){
  ...
  SQLInsertUpdateCall("setBuyPct: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function setTransactionPending($id){
  ...
  SQLInsertUpdateCall("setTransactionPending: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function setTransactionStatus($id,$status){
  ...
  SQLInsertUpdateCall("setTransactionStatus: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function fixResidual(){
  ...
  SQLInsertUpdateCall("fixResidual: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSellAmount($TransactionID,$Amount,$oldAmount){
  ...
  SQLInsertUpdateCall("updateSellAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function closeNewTrackingSellCoin($ID){
  ...
  SQLInsertUpdateCall("closeNewTrackingSellCoin: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function addBuyBackOverride($overrideBBAmount,$overrideBBSaving,$TransactionID){
  ...
  SQLInsertUpdateCall("addBuyBackOverride: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function setNewTrackingSellPrice($coinPrice, $ID){
  ...
  SQLInsertUpdateCall("setNewTrackingSellPrice: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateNoOfRisesInSellPrice($newTrackingCoinID, $num, $price){
  ...
  SQLInsertUpdateCall("updateNoOfRisesInSellPrice: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function reopenTransaction($id){
  ...
  $sql = "UPDATE `Transaction`
            SET `Status`= CASE
             ...
             END
            WHERE `ID` = $id";
  SQLInsertUpdateCall("reopenTransaction: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function logHoldingTimeToSQL($coinID, $holdingMins){
  ...
  SQLInsertUpdateCall("logHoldingTimeToSQL: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function cancelTrackingSell($id){
  ...
  SQLInsertUpdateCall("cancelTrackingSell: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSQLQuantity($uuid, $quantity){
  ...
  SQLInsertUpdateCall("updateSQLQuantity: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function pauseRule($id, $hours, $userID = 0){
  ...
  SQLInsertUpdateCall("pauseRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateBittrexBalances($symbol, $total, $price, $userID,$base, $coinID){
    ...
    SQLInsertUpdateCall("updateBittrexBalances: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function deleteBittrexBalances(){
    ...
    SQLInsertUpdateCall("deleteBittrexBalances: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function addUSDTBalance($symbol, $usdtPurchase, $price, $userID){
    ...
    SQLInsertUpdateCall("addUSDTBalance: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function subUSDTBalance($symbol, $usdtPurchase, $price, $userID){
    ...
    SQLInsertUpdateCall("subUSDTBalance: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*print_r($sql);
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
    } else {
...
function pauseTracking($userID){
  ...
  SQLInsertUpdateCall("pauseTracking: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function getLiveMarketPrice($status){
  ...
  //mysqli_fetch_assoc($result);
  while ($row = mysqli_fetch_assoc($result)){
      $tempAry[] = Array($row['IDCn'],$row['Symbol'],$row['LiveBuyOrders'],$row['LastBuyOrders'],$row['BuyOrdersPctChange'],$row['LiveMarketCap'],$row['LastMarketCap'],$row['MarketCapPctChange'],$row['Live1HrChange'] //8
...
function writeMarketPrice($price){
  ...
  SQLInsertUpdateCall("writeMarketPrice: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function assignNewSellID($transID, $sellRuleID){
  ...
  SQLInsertUpdateCall("assignNewSellID: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function setTransStatus($status,$transID){
  ...
  $sql = "UPDATE `Transaction` SET `Status` = '$status', `SpreadBetRuleID` = 0,`SpreadBetTransactionID` = 0, `Type` = 'Sell'
          WHERE `ID` = $transID";
  SQLInsertUpdateCall("setTransStatus: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function setCustomisedSellRule($buyRule, $coinID){
  ...
  if ($conn->connect_error) {
    ...
    SQLInsertUpdateCall("setCustomisedSellRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function setCustomisedSellRuleBased($buyRule, $coinID, $pctToSell){
  ...
  if ($conn->connect_error) {
    ...
    SQLInsertUpdateCall("setCustomisedSellRuleBased: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function coinSwapSell($livePrice, $transactionID,$coinID,$buyRule, $buyAmount){
  ...
  SQLInsertUpdateCall("coinSwapSell: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateBuyAmount($transactionID, $amount){
  ...
  SQLInsertUpdateCall("updateBuyAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function cancelTrackingBuy($ruleId,$reason){
  ...
  SQLInsertUpdateCall("cancelTrackingBuy: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateTypeToBittrex($type,$transID){
  ...
  SQLInsertUpdateCall("updateTypeToBittrex: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateTypeToTrans($type,$transID){
  ...
  SQLInsertUpdateCall("updateTypeToTrans: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function UpdateSpreadBetTotalProfit(){
  ...
  SQLInsertUpdateCall("UpdateSpreadBetTotalProfit: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function extendPctToBuy($coinID, $userID){
  ...
  if ($conn->connect_error) {
    ...
    SQLInsertUpdateCall("extendPctToBuy: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function SpreadBetBittrexCancelPartialSell($oldID,$coinID, $quantity){
  ...
  if ($conn->connect_error) {
    ...
    $sql = "UPDATE `Transaction` AS `t1` JOIN `Transaction` AS `t2` ON `t2`.`ID` = $oldID
            ...
            order by `ID` Desc
            limit 1 ";
    SQLInsertUpdateCall("SpreadBetBittrexCancelPartialSell: ",$sql,3, 1, 1, 0, "NewConfig", 90);
...
function SpreadBetBittrexCancelPartialBuy($transactionID,$quantity){
  ...
  if ($conn->connect_error) {
    ...
    SQLInsertUpdateCall("SpreadBetBittrexCancelPartialBuy: ",$sql,3, 1, 1, 0, "NewConfig", 90);
...
function updateTransToSpread($SBRuleID,$coinID, $userID,$SBTransID){
  ...
  if ($conn->connect_error) {
    ...
    SQLInsertUpdateCall("updateTransToSpread: ",$sql,3, 1, 1, 0, "NewConfig", 90);
...
function writeCalculatedSellPct($transID, $userID,$sellPct,$ruleIDSell,$calculatedSellPctReduction){
  /*$conn = getSQLConn(rand(1,3));
  // Check connection
  if ($conn->connect_error) {
      die("Connection failed: " . $conn->connect_error);
    ...
    $sql = "Call writeCalculatedSellPct($transID, $userID,$sellPct,$ruleIDSell,$calculatedSellPctReduction);";
    SQLInsertUpdateCall("writeCalculatedSellPct: ",$sql,3, 1, 1, 0, "NewConfig", 90);
    /*LogToSQL("updateTransToSpread",$sql,3,1);
  print_r("<BR>".$sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
...
function updateToSpreadSell($transID){
  ...
  if ($conn->connect_error) {
    ...
    SQLInsertUpdateCall("updateToSpreadSell: ",$sql,3, 1, 1, 0, "NewConfig", 90);
...
function newSpreadTransactionID($UserID, $spreadBetRuleID){
  ...
  if ($conn->connect_error) {
    ...
    SQLInsertUpdateCall("newSpreadTransactionID: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function addProfitToAllocation($UserID, $totalProfitUSD,$saveMode,$baseCurrency,$overrideBBSaving,$type,$spreadBetTransactionID){
  ...
  $sql = "call AddToUserCoinSavings($UserID,$totalProfitUSD,'$baseCurrency',$overrideBBSaving,'$type',$spreadBetTransactionID)";
  SQLInsertUpdateCall("addProfitToAllocation: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
...
function updateSpreadBuy($spreadBetRuleID){
  ...
  SQLInsertUpdateCall("updateSpreadBuy: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function delaySavingBuy($transactionID,$delayMins, $mode, $userID,$baseCurrency){
  ...
  SQLInsertUpdateCall("delaySavingBuy: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
  ...
  newLogToSQL("delaySavingBuy",$sql." - Mode: ".$mode,3,1,"SQL","TransID:$transactionID");*/
}
...
function updateSpreadProfit($spreadBetRuleID, $pctProfit){
  ...
  SQLInsertUpdateCall("updateSpreadProfit: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSpreadSell($spreadBetRuleID, $orderDate){
  ...
  SQLInsertUpdateCall("updateSpreadSell: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateBuyTrend($coinID, $transactionID, $mode, $ID, $hr1, $hr24, $d7){
  ...
  SQLInsertUpdateCall("updateBuyTrend: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSpreadBetPctAmount($spreadBetRuleID){
  ...
  SQLInsertUpdateCall("updateSpreadBetPctAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSpreadBetTransactionAmount($nPrice, $spreadBetRuleID, $BTCAmount){
  ...
  SQLInsertUpdateCall("updateSpreadBetTransactionAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateMaxPctToSql($price, $coinID, $mode, $ruleID){
  ...
  SQLInsertUpdateCall("updateMaxPctToSql: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSQLcancelSpreadBetTrackingSell($TransactionID){
  ...
  SQLInsertUpdateCall("updateSQLcancelSpreadBetTrackingSell: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function enableBuyRule($buyRuleID, $buyCoin,$PctChangeAvg,$pctChangeTargetAvg){
  ...
  SQLInsertUpdateCall("enableBuyRule: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function buySellProfitEnable($coinID,$userID,$enableBuy, $enableSell,$nPct,$FixSellRule){
  ...
  SQLInsertUpdateCall("buySellProfitEnable: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function setPriceDipEnable($ruleID,$status,$buyCoin,$liveCoinPriceMkt){
  ...
  SQLInsertUpdateCall("setPriceDipEnable: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function writePriceDipHours($ruleID,$dipHourCounter){
  ...
  SQLInsertUpdateCall("writePriceDipHours: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function writePriceDipCoinHours($coinID,$dipHourCounter,$dipHourCounterLow,$dipHourCounterHigh){
  ...
  SQLInsertUpdateCall("writePriceDipCoinHours: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function writeCoinPriceDipPrice($coinID,$price){
  ...
  SQLInsertUpdateCall("writeCoinPriceDipPrice: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function reOpenTransactionfromBuyBackNew($buyBackID){
  ...
  SQLInsertUpdateCall("reOpenTransactionfromBuyBackNew: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function addToBuyBackMultiplier($buyBackID,$addNum,$buyBackPct,$multiplier, $base){
  ...
  SQLInsertUpdateCall("addToBuyBackMultiplier: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function closeBuyBack($buyBackID){
  ...
  SQLInsertUpdateCall("closeBuyBack: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function buyBackDelay($coinID, $mins,$tmpUserID){
  ...
  SQLInsertUpdateCall("buyBackDelay: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function WriteBuyBack($transactionID, $profitPct, $noOfRisesInPrice, $minsToCancel,$finalPrice,$amount,$cost,$usd_Amount,$buyBackEnabled,$overrideAmount,$overrideSaving,$spreadBetRuleID){
  /*$conn = getSQLConn(rand(1,3));
  // Check connection
  if ($conn->connect_error) {
      die("Connection failed: " . $conn->connect_error);
  ...
  $sql = "Call WriteBuyBack($transactionID,$noOfRisesInPrice,$profitPct,$minsToCancel,$finalPrice,$amount,$cost,$usd_Amount,$buyBackEnabled,$overrideAmount,$overrideSaving,$spreadBetRuleID);";
  SQLInsertUpdateCall("WriteBuyBack: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function runSpreadBetComplete($spreadBetRuleID){
  ...
  $sql = "CALL checkSpreadBetComplete($spreadBetRuleID);";
  SQLInsertUpdateCall("runSpreadBetComplete: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*$sql = "SELECT count(`ID`) as SBCount FROM `Transaction` WHERE `SpreadBetRuleID` = $spreadBetRuleID and `Status` in ('Open','Pending');";
  //print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
...
function writeProfitToWebTable($spreadBetTransactionID,$originalPurchasePrice, $liveTotalPrice, $saleTotalPrice){
  ...
  SQLInsertUpdateCall("writeProfitToWebTable: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateBuyBackKittyAmount($tmpBaseCur,$bbKittyAmount,$tmpUserID){
  ...
  SQLInsertUpdateCall("updateBuyBackKittyAmount: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function WriteWebMarketStats($marketPctChangeHr1,$marketPctChangeHr24,$marketPctChangeD7){
  ...
  SQLInsertUpdateCall("WriteWebMarketStats: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSpreadBetTotalProfitBuy($transactionID, $coinPrice, $amount){
  ...
  SQLInsertUpdateCall("updateSpreadBetTotalProfitBuy: ",$sql,3, 1, 1, 0, "NewConfig", 90);
...
function updateSpreadBetTotalProfitSell($transactionID,$salePrice){
  ...
  SQLInsertUpdateCall("updateSpreadBetTotalProfitSell: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function updateSpreadBetSellTarget($transactionID){
  ...
  SQLInsertUpdateCall("updateSpreadBetSellTarget: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*logToSQL("BittrexSQL", "$sql", 3, 1);
  //print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
...
function deleteSpreadBetTotalProfit($spreadBetTransactionID){
  ...
  if ($conn->connect_error) {
    ...
    SQLInsertUpdateCall("deleteSpreadBetTotalProfit: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function deleteSpreadBetTrackingCoins($spreadBetTransactionID, $mode = 0){
  ...
  SQLInsertUpdateCall("deleteSpreadBetTrackingCoins: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
      echo "Error: " . $sql . "<br>" . $conn->error;
...
function deleteReduceLossTrackingCoins($userID,$baseCurrency){
    ...
    SQLInsertUpdateCall("deleteReduceLossTrackingCoins: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function CloseAllBuyBack($spreadBetTransactionID){
  ...
  SQLInsertUpdateCall("CloseAllBuyBack: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r($sql);
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
...
function subPctFromProfitSB($sBTransID,$pctToSub, $transactionID){
  ...
  SQLInsertUpdateCall("subPctFromProfitSB: ",$sql,3, 1, 1, 0, "NewConfig", 90);
  /*print_r("<BR>".$sql."<BR>");
  if ($conn->query($sql) === TRUE) {
      echo "New record created successfully";
  } else {
