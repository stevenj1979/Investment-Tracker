...
//12
  ...
  ,`OverrideCancelBuyTimeMins`,`NoOfBuyModeOverrides`,`CoinModeOverridePriceEnabled`,`OverrideCoinAllocation`,`OneTimeBuyRule`
  ...
  ,$row['OverrideCoinAllocation'],$row['OneTimeBuyRule']);
  }
  $conn->close();
  return $tempAry;
}
