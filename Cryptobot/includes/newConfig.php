...
function getSpreadBetTrackingCoins($whereclause, $table){
  ...
  if ($conn->connect_error) {
    ...
    ,sum(`Last1HrChange`) as Last1HrChange,sum((`Live1HrChange`-`LiveCoinPrice`)/100)*`LiveCoinPrice` as Hr1ChangePctChange ,sum(`Live24HrChange`) as Live24HrChange,sum(`Last24HrChange`) as Last24HrChange,sum((`Live24HrChange`-`LiveCoinPrice`)/100)*`LiveCoinPrice` as Hr24ChangePctChange,sum(`Live7DChange`) as Live7DChange,sum(`Last7DChange`) as Last7DChange
    ,sum((`Live7DChange`-`LiveCoinPrice`)/100)*`LiveCoinPrice` as D7ChangePctChange,Trim(sum(`LiveCoinPrice`))+0 as LiveCoinPrice,Trim(sum(`LastCoinPrice`))+0 as LastCoinPrice,sum(`CoinPricePctChange`) as CoinPricePctChange,sum(`LiveSellOrders`) as LiveSellOrders,sum(`LastSellOrders`) as LastSellOrders,sum(`SellOrdersPctChange`) as SellOrdersPctChange
