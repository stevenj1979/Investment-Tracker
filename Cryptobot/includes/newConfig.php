...
function trackingCoinReadyToBuy($livePrice, $mins, $type, $buyPrice, $TransactionID, $NoOfRisesInPrice, $pctProfit, $minsFromDate, $lastPrice, $totalRisesInPrice, $trackingID,$quickBuyCount,$market1HrChangePct,$oneTimeBuy){
  ...
  if ((($livePrice-$buyPrice) < $swingPrice) OR ($livePrice > $buyPrice)){ //OR ($currentPrice < $swingPrice)
...
function trackingCoinReadyToSell($livePrice, $mins, $type, $sellPrice, $TransactionID, $NoOfRisesInPrice, $pctProfit, $minsFromDate, $lastPrice, $totalRisesInPrice, $trackingSellID,$market1HrChangePct){
    ...
    //$bottomPrice = $livePrice-$swingPrice;
    echo "<BR> SwingPrice: $swingPrice | currentPrice: $currentPrice";
    if ($pctProfit >= 20.0){
    ...
    echo "<BR>trackingCoinReadyToSell: $mins | $livePrice | $sellPrice | $NoOfRisesInPrice | $totalRisesInPrice | $trackingSellID | $TransactionID";
    ...
    if($currentPrice <= $swingPrice){
      ...
      echo "updateNoOfRisesInSellPrice($trackingSellID, $NoOfRisesInPrice+1, $livePrice);";
