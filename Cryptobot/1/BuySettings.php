 ...
 for($x = 0; $x < $userSettingsLen; $x++) {
   ...
   //if ($buyCoin == $flag){
     ...
     if ($title == "Enabled Rules"){
       echo "<td rowspan='3'><a href='BuySettings.php?startTimer=Yes&id=$ruleID'><i class='fas fa-play-circle' style='font-size:22px;color:DodgerBlue'></i></a></td>";

     }else{
       echo "<td rowspan='3'><a href='BuySettings.php?resetTimer=Yes&id=$ruleID'><i class='fas fa-stop-circle' style='font-size:22px;color:DodgerBlue'></i></a></td>";
     }
