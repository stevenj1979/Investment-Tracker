...
<!--<div class="container">
	...
	<div class="row">
        ...
        for($x = 0; $x < $arrLengthSell; $x++) {
            ...
            $profitNow = ($livePrice * $amount);
            $profitOrig = ($purchaseCost * $amount);
            $profit = ($profitNow - $profitOrig - $fee);
            ...
            NewEcho("<td id='cNchart' rowspan='2'>$profitNow</td>",$_SESSION['isMobile'],1);
