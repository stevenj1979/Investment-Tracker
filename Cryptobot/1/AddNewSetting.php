...
function copyRule($ID){
  ...
  ,`LimitBuyAmountEnabled`,`LimitBuyAmount`,`RuleName`)
...
,`1HrChangeTrendEnabled`,`1HrChangeTrend`,`CoinPriceMatchID`,`CoinPricePatternID`,`Coin1HrPatternID`,`BuyRisesInPrice`,`OverrideDisableRule`,`LimitBuyAmountEnabled`,`LimitBuyAmount`,`RuleName`
from `BuyRules`
where `ID` = $ID";
  //print_r($sql);
  if ($conn->query($sql) === TRUE) {
