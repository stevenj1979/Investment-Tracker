...
include_once '/home/stevenj1979/Investment-Tracker/Cryptobot/1/includes/newConfig.php';?>
<style>
...
displayHeader(3);
        ...
        //$user = getUserIDs($_SESSION['ID']);
				...
				print_r("<h2>Buy Coins Mobile!</h2><Table><th>&nbspCoin</th><TH>&nbspBase Currency</th><TH>&nbspPrice</th><TH>&nbspMarket Cap %</th><TH>&nbspVolume by %</th><TH>&nbspBuy Orders %</th><TH>&nbspPrice Diff 1</th><TH>&nbspPrice Change</th><TH>&nbsp% Change 1Hr</th><TH>&nbsp% Change 24 Hrs</th>
