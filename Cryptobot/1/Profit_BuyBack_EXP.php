...
<!--<div class="container">
	...
	<div class="row">
        ...
        tableHeader('Symbol','BB_TransactionID','Original Purchase Price','Sale Price','Fee','Profit BTC','Profit USDT','Profit ETH','Profit USD','Year Sold','Month Sold','Day Sold');
        for($x = 0; $x < $arrlength; $x++) {
                    ...
                    tableRow($symbol,$buyBackTransID,$purchasePrice,$sellPrice,$fee,$profitBTC, $profitUSDT, $profitETH, $profitUSD,$sellYear,$sellMonth,$sellDay);
