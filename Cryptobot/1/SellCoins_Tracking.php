...
<!--<div class="container">
	...
	<div class="row">
        ...
        for($x = 0; $x < $arrLengthSell; $x++) {
          ...
          NewEcho ("<td>$Amount</td>",$_SESSION['isMobile'],2);
          NewEcho ("<td>$NoOfRisesInPrice</td>",$_SESSION['isMobile'],2);
          NewEcho ("<td>$TransactionID</td>",$_SESSION['isMobile'],1);
          NewEcho ("<td>$OrderNo</td>",$_SESSION['isMobile'],1);
          NewEcho ("<td>$FixSellRule</td>",$_SESSION['isMobile'],1);
          NewEcho ("<td>$LiveCoinPrice</td>",$_SESSION['isMobile'],2);
          NewEcho ("<td>$profit</td>",$_SESSION['isMobile'],2);
          NewEcho ("<td>$fee</td>",$_SESSION['isMobile'],1);
          NewEcho ("<td>$ProfitPct</td>",$_SESSION['isMobile'],2);
          NewEcho ("<td>$totalRisesInPrice</td>",$_SESSION['isMobile'],1);
          NewEcho ("<td>$ogPctProfit<td>",$_SESSION['isMobile'],2);
          echo "</tr>";
        }
        print_r("</table>");
				displaySideColumn();
