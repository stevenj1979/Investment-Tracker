...
<!--<div class="container">
	...
	<div class="row">
        ...
        for($x = 0; $x < $arrLengthSell; $x++) {
            ...
            echo "<td><p id='largeText' >".round($profitPct[0][4],$roundVar)." $baseCurrency</p></td>";
            ...
            $numCol = getNumberColour($profitPct[0][0]);
            echo "<td><p id='smallText' style='color:$numCol'>".round($profitPct[0][0],$roundVar)."</p></td>";
